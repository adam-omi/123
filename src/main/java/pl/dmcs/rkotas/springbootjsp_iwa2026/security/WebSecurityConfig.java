package pl.dmcs.rkotas.springbootjsp_iwa2026.security;
...
import pl.dmcs.rkotas.springbootjsp_iwa2026.security.jwt.JwtAuthEntryPoint;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                // To disable anonymous user authentication. This forces all users to authenticate, blocking access
                // to public, non-credentialed sessions and ensuring only authorized users access resources.
